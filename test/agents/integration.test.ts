...
import { Concept, ScoutReport, Decomposition, Explanation, BuilderOutput } from '../../src/core/types';
...
describe('Comprehensive Agent Integration Tests', () => {
    ...
    const mockScoutReport: ScoutReport = {
        ...
        resources: { official: { name: 'MDN', qualityScore: 5, url: 'https://mdn.io' } },
        resourceWarnings: [],
        searchQueriesUsed: []
    };
    ...
    const mockExplanation: Explanation = {
        ...
        whyExists: { before: 'Floats', pain: 'Hard to align', after: 'Easy alignment' },
        codeExample: { language: 'css', code: '.container { display: flex; }', whatHappens: 'Items align in row' }
    };
    ...
    describe('Clarifier Agent', () => {
        ...
        it('should identify ambiguity', async () => {
    ...
    describe('Decomposer Agent', () => {
        ...
        it('should decompose topic', async () => {
    ...
    describe('Critic & Iterator Agents', () => {
        ...
        it('should critique and improve', async () => {
            const draftText = `Simple explanation of ${mockConcept.name}`;
    ...
    describe('Builder Agent', () => {
        ...
        it('should build guide metadata', async () => {
            const result = await agent.execute({
    ...
    describe('Synthesizer Agent', () => {
        ...
        it('should synthesize final markdown', async () => {
            const result = await agent.execute({
                scoutReport: mockScoutReport,
                decomposition: mockDecomposition,
                explanations: [mockExplanation],
